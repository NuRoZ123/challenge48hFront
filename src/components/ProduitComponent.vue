        ...
        -->
				<div className="px-5 pb-5">
					...
					<div className="flex items-center space-x-10 justify-between">
						...
						<a href="#" v-on:click="ajouterAuPanier" className="text-white bg-[#FFC72C] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</a>
					</div>
				</div>
			</div>	
    </div>
